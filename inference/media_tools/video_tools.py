...
def write_video(video_path:str,output_path:str,object_detection_model, keypoint_detection_model = None, stylized = True):
    """
    ...
    if object_detection_model is not  None:
        ...
        for _ in tqdm(range(total_frames),desc="Processing"):
            ...
            #Marcamos objetos
            object_detections = object_detection_model(frame,verbose = False)
        ...
        print("No hay modelo de deteccion")
