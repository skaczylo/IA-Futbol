    ...
    for json in os.listdir(os.path.join(folder_path,"soccernet_labels")): #Leemos jsons
        ...
        for class_id, pt in intersections.items():
            if pt is not None:
                ...
                # Pequeña medida de seguridad para que el centro no se salga de los límites [0.0, 1.0]
...
#new_labels("field_localization/dataset/train")
new_labels("field_localization/dataset/valid")
new_labels("field_localization/dataset/test")
